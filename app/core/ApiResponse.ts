...
export class SuccessResponse<T> extends ApiResponse {
    ...
    send(res: Response, req?: any): Response {
        LogServices.saveLogDataAdminCronjob(req);
...
export class RedirectResponse<T> extends ApiResponse {
    ...
    constructor(route: string) {
        super(StatusCode.SUCCESS, ResponseStatus.SUCCESS, 'Redirect');
        this.route = route;
    }
...
export class EmailNotVerifyResponse extends ApiResponse {
    constructor(message = 'Email not verify') {
        super(StatusCode.EMAIL_NOT_VERIFY, ResponseStatus.BAD_REQUEST, message);
    }
}
